  ...
  $.fn.panorama_viewer = function(options) {
    ...
    return this.each(function() {
      ...
      // el.find("> img").load(function() {
        ...
        // setting for spots
        $.each(el.find('.spot'), function(i, e) {
          var spotPosition = {
          ...
          $(e).css('left', spotPosition.x)
            .css('top', spotPosition.y);
        });
        ...
        function move(e) {
          ...
          $.each($('.spot'), function(i, e) {
            ...
            $(e).css('left', spotPosition.x + offset.x)
              .css('top', spotPosition.y + offset.y);
          });
